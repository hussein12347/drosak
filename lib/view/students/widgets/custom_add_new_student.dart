...
class CustomAddNewStudent extends StatefulWidget {
  const CustomAddNewStudent({
    super.key,
  ...
  @override
  State<CustomAddNewStudent> createState() => _CustomAddNewStudentState();
}

class _CustomAddNewStudentState extends State<CustomAddNewStudent> {
  @override
  void initState() {
    super.initState();
